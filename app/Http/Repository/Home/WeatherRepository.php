	...
	public function addAll($request)
{
    try {
        ...
        $request->english_image->storeAs('public/images/weather', $englishImage);
        $request->marathi_image->storeAs('public/images/weather', $marathiImage);
...
public function updateAll($request)
{
    try {
        ...
        Storage::delete([
            'public/images/weather/' . $weather_data->marathi_image,
            'public/images/weather/' . $weather_data->english_image
        ]);
...
public function deleteById($id)
{
    try {
        ...
        if ($weather) {
            ...
            Storage::delete([
                'public/images/weather/'.$weather->marathi_image,
                'public/images/weather/'.$weather->english_image,
