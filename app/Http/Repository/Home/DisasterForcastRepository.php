	...
	public function addAll($request)
{
    try {
        ...
        $request->english_image->storeAs('public/images/disaster-forcast', $englishImage);
        $request->marathi_image->storeAs('public/images/disaster-forcast', $marathiImage);
...
public function updateAll($request)
{
    try {
        ...
        Storage::delete([
            'public/images/disaster-forcast/' . $disasterforcast_data->marathi_image,
            'public/images/disaster-forcast/' . $disasterforcast_data->english_image
        ]);
...
public function deleteById($id)
{
    try {
        ...
        if ($disasterforcast) {
            ...
            Storage::delete([
                'public/images/disaster-forcast/'.$disasterforcast->marathi_image,
                'public/images/disaster-forcast/'.$disasterforcast->english_image,
