...
class DynamicPagesController extends Controller
{
   ...
   public function __construct()
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            if($validation->fails()) {
                ...
                $this->savePageData($request, $menu_selected, $main_menu_data, $new_name, $menu_name, $data['menu_id']);
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.pages.dynamic-pages.edit-page', compact('html_marathi', 'html_english', 'edit_data_id'));
    }
    public function update(Request $request) {
        ...
        try {
            ...
            if($validation->fails()) {
                ...
                $this->savePageData($request, $menu_selected, $main_menu_data, $new_name, $menu_name, $main_menu_data->menu_id);
                $msg = "Page data saved successfully";
                $status = "successfully";
                return redirect('list-dynamic-page')->with(compact('msg','status'));
    ...
    public function savePageData($request, $menu_selected, $main_menu_data, $new_name, $menu_name, $menu_id) {
