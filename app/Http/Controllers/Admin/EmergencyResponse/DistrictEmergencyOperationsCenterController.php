...
use App\Http\Services\Admin\EmergencyResponse\DistrictEmergencyOperationsCenterServices;
use Validator;
use Config;
class DistrictEmergencyOperationsCenterController extends Controller
{
    ...
    //  die();
        $rules = [
            ...
            'english_image' => 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MAX_SIZE").'|dimensions:min_width=1500,min_height=500,max_width=2000,max_height=1000|min:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MIN_SIZE").'',
            'marathi_image' => 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MAX_SIZE").'|dimensions:min_width=1500,min_height=500,max_width=2000,max_height=1000|min:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MIN_SIZE").'',
        ...
        public function update(Request $request)
    {
        $rules = [
         ...
         if($request->has('english_image')) {
            $rules['english_image'] = 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MAX_SIZE").'|dimensions:min_width=1500,min_height=500,max_width=2000,max_height=1000|min:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MIN_SIZE");
        }
        if($request->has('marathi_image')) {
            $rules['marathi_image'] = 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MAX_SIZE").'|dimensions:min_width=1500,min_height=500,max_width=2000,max_height=1000|min:'.Config::get("AllFileValidation.DISTRICT_EMERGENCY_OPERATION_CENTER_IMAGE_MIN_SIZE");
        }
