...
use App\Http\Services\Admin\PoliciesAndGuidelines\DisasterManagementActServices;
use Validator;
use Config;
use Illuminate\Validation\Rule;
class DisasterManagementActController extends Controller
{

    public function __construct()
        {
            $this->service = new DisasterManagementActServices();
        }
        public function index()
        {
            try {
                $relevant_laws = $this->service->getAll();
                return view('admin.pages.policies-and-guidelines.disaster-management-act.list-disaster-management-act', compact('relevant_laws'));
            } catch (\Exception $e) {
                return $e;
            }
        }
        public function add()
        {
            return view('admin.pages.policies-and-guidelines.disaster-management-act.add-disaster-management-act');
        }
        ...
        try {
            ...
            if($validation->fails() )
            {
                return redirect('add-disaster-management-act')
                    ->withInput()
            ...
            else
            {
                ...
                if($add_relevant_laws)
                {
                    ...
                    if($status=='success') {
                        return redirect('list-disaster-management-act')->with(compact('msg','status'));
                    }
                    else {
                        return redirect('add-disaster-management-act')->withInput()->with(compact('msg','status'));
                    }
                }

            }
        } catch (Exception $e) {
            return redirect('add-disaster-management-act')->withInput()->with(['msg' => $e->getMessage(), 'status' => 'error']);
        }
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.pages.policies-and-guidelines.disaster-management-act.edit-disaster-management-act', compact('relevant_laws'));
    }
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('admin.pages.policies-and-guidelines.disaster-management-act.show-disaster-management-act', compact('relevant_laws'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    public function updateOne(Request $request)
    {
        ...
        $result = $this->service->updateOne($active_id);
            return redirect('list-disaster-management-act')->with('flash_message', 'Updated!');  
        } catch (\Exception $e) {
            return $e;
        }
    }
