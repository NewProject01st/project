...
use App\Http\Services\Admin\PoliciesAndGuidelines\StateDisasterManagementPlanServices;
use Validator;
use Config;
   ...
   public function __construct(){
    ...
    public function index(){
        try {
            ...
            return view('admin.pages.policies-and-guidelines.state-management.list-state-management-plan', compact('state_management'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    public function add(){
        return view('admin.pages.policies-and-guidelines.state-management.add-state-management-plan');
    }
    ...
    public function edit(Request $request){
        ...
        return view('admin.pages.policies-and-guidelines.state-management.edit-state-management-plan', compact('state_management'));
    }
    ...
    public function show(Request $request){
        try {
            ...
            return view('admin.pages.policies-and-guidelines.state-management.show-state-management-plan', compact('state_management'));
        } catch (\Exception $e) {
            return $e;
        }
    }
