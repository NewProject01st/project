...
use App\Http\Services\Admin\PoliciesAndGuidelines\DisasterManagementGuidelinesServices;
use Validator;
use Config;
use Illuminate\Validation\Rule;
class DisasterManagementGuidelinesController extends Controller
{

    public function __construct()
        {
            $this->service = new DisasterManagementGuidelinesServices();
        }
        public function index()
        {
            try {
                $relevant_laws = $this->service->getAll();
                return view('admin.pages.policies-and-guidelines.disaster-management-guidelines.list-disaster-management-guidelines', compact('relevant_laws'));
            } catch (\Exception $e) {
                return $e;
            }
        }
        public function add()
        {
            return view('admin.pages.policies-and-guidelines.disaster-management-guidelines.add-disaster-management-guidelines');
        }
        ...
        try {
            ...
            if($validation->fails() )
            {
                return redirect('add-disaster-management-guidelines')
                    ->withInput()
            ...
            else
            {
                ...
                if($add_relevant_laws)
                {
                    ...
                    if($status=='success') {
                        return redirect('list-disaster-management-guidelines')->with(compact('msg','status'));
                    }
                    else {
                        return redirect('add-disaster-management-guidelines')->withInput()->with(compact('msg','status'));
                    }
                }

            }
        } catch (Exception $e) {
            return redirect('add-disaster-management-guidelines')->withInput()->with(['msg' => $e->getMessage(), 'status' => 'error']);
        }
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.pages.policies-and-guidelines.disaster-management-guidelines.edit-disaster-management-guidelines', compact('relevant_laws'));
    }
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('admin.pages.policies-and-guidelines.disaster-management-guidelines.show-disaster-management-guidelines', compact('relevant_laws'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    public function updateOne(Request $request)
    {
        ...
        $result = $this->service->updateOne($active_id);
            return redirect('list-disaster-management-guidelines')->with('flash_message', 'Updated!');  
        } catch (\Exception $e) {
            return $e;
        }
    }
