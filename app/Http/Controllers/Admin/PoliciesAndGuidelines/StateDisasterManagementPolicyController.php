...
use App\Http\Services\Admin\PoliciesAndGuidelines\StateDisasterManagementPolicyServices;
use Validator;
use Config;
   ...
   public function __construct()
    ...
    public function index(){
        try {
            ...
            return view('admin.pages.policies-and-guidelines.state-policy.list-state-management-policy', compact('state_policy'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    ...
    public function add(){
        return view('admin.pages.policies-and-guidelines.state-policy.add-state-management-policy');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.pages.policies-and-guidelines.state-policy.edit-state-management-policy', compact('state_policy'));
    }
    ...
    public function update(Request $request){
        ...
        if($request->has('english_pdf')) {
            $rules['english_pdf'] = 'required|file|mimes:pdf|max:'.Config::get("AllFileValidation.STATE_DISASTER_MANAGEMENT_POLICY_PDF_MAX_SIZE").'|min:'.Config::get("AllFileValidation.STATE_DISASTER_MANAGEMENT_POLICY_PDF_MIN_SIZE").'';
        }
        if($request->has('marathi_pdf')) {
            $rules['marathi_pdf'] = 'required|file|mimes:pdf|max:'.Config::get("AllFileValidation.STATE_DISASTER_MANAGEMENT_POLICY_PDF_MAX_SIZE").'|min:'.Config::get("AllFileValidation.STATE_DISASTER_MANAGEMENT_POLICY_PDF_MIN_SIZE").'';
        }
        $messages = [   
            'english_title.required'=>'Please enter title.',
            'english_title.regex' => 'Please  enter text only.',
    ...
    public function show(Request $request){
        try {
            ...
            return view('admin.pages.policies-and-guidelines.state-policy.show-state-management-policy', compact('state_policy'));
        } catch (\Exception $e) {
            return $e;
        }
    }
