...
class ContentSecurityPolicy
{
    public function handle(Request $request, Closure $next)
    {
        ...
        $response->headers->set('X-Content-Security-Policy', "script-src 'self' 'unsafe-eval' https://www.google-analytics.com https://code.jquery.com;"); // For older browsers that don't support CSP Level 2
        $response->headers->set('X-WebKit-CSP', "script-src 'self' 'unsafe-eval' https://www.google-analytics.com https://code.jquery.com ;"); // For older versions of Chrome/Safari
