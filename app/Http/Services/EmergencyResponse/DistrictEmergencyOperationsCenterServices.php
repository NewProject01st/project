        ...
        try {
            ...
            if ($request->hasFile('english_image')) {
                if ($return_data['english_image']) {
                    if (file_exists(storage_path(Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_DELETE') . $return_data['english_image']))) {
            ...
            if ($request->hasFile('marathi_image')) {
                if ($return_data['marathi_image']) {
                    if (file_exists(storage_path(Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_DELETE') . $return_data['marathi_image']))) {
