        ...
        try {
            ...
            if ($request->hasFile('english_pdf')) {
                if ($return_data['english_pdf']) {
                    $delete_file_eng= storage_path(Config::get('DocumentConstant.STATE_DISASTER_PLAN_DELETE') . $return_data['english_pdf']);
            ...
            if ($request->hasFile('marathi_pdf')) {
                if ($return_data['marathi_pdf']) {
                    $delete_file_mar= storage_path(Config::get('DocumentConstant.STATE_DISASTER_PLAN_DELETE') . $return_data['marathi_pdf']);
