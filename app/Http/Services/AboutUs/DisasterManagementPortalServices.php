        ...
        try {
            ...
            if ($request->hasFile('english_image')) {
                if ($return_data['english_image']) {
                    $delete_file_path_eng  = storage_path(Config::get('DocumentConstant.ABOUT_US_DISASTER_MGT_PORTAL_DELETE') . $return_data['english_image']);
            ...
            if ($request->hasFile('marathi_image')) {
                if ($return_data['marathi_image']) {
                    $delete_file_path_marathi = storage_path(Config::get('DocumentConstant.ABOUT_US_DISASTER_MGT_PORTAL_DELETE') . $return_data['marathi_image']);
