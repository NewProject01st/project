        ...
        try {
            ...
            if ($request->hasFile('english_image')) {
                if ($return_data['english_image']) {
                    $delete_file_eng= storage_path(Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_DELETE') . $return_data['english_image']);
            ...
            if ($request->hasFile('marathi_image')) {
                if ($return_data['marathi_image']) {
                    $delete_file_mar= storage_path(Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_DELETE') . $return_data['marathi_image']);
