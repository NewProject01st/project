           ...
           $return_data = $this->repo->updateAll($request);
            ...
            if ($request->hasFile('english_image')) {
                if ($return_data['english_image']) {
                    $delete_file_eng= storage_path(Config::get('DocumentConstant.PUBLIC_AWARENESS_EDUCATION_DELETE') . $return_data['english_image']);
            ...
            if ($request->hasFile('marathi_image')) {
                if ($return_data['marathi_image']) {
                    $delete_file_mar= storage_path(Config::get('DocumentConstant.PUBLIC_AWARENESS_EDUCATION_DELETE') . $return_data['marathi_image']);
