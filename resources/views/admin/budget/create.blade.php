    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" action="{{ url('budget') }}" method="post" id="regForm">
                        {!! csrf_field() !!}   
                        <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control fld_english_description"  name="fld_english_description" id="fld_english_description" placeholder="Enter the Description" name="description"></textarea>
                                ...
                                <textarea class="form-control fld_marathi_description"  name="fld_marathi_description" id="fld_marathi_description" placeholder="Enter the Description"></textarea>
                            </div>
                           </div>
