...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
            Tenders List <a href="{{ url('/policiesacts/create') }}" class="btn btn-sm btn-primary ml-3">+ Add</a>
            </h3>
