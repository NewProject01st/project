...
@section('content')
    ...
    <div class="main-panel">
                                                ...
                                                @foreach ($awareness_education as $item)
                                                    <tr>
                                                        ...
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.PUBLIC_AWARENESS_EDUCATION_VIEW') }}{{ $item->english_image }}" alt=" {{ strip_tags($item['english_title']) }} Image"/>
                                                        </td>
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.PUBLIC_AWARENESS_EDUCATION_VIEW') }}{{ $item->marathi_image }}" alt=" {{ strip_tags($item['marathi_title']) }} प्रतिमा"/>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
        ...
        <form method="GET" action="{{ url('/edit-public-awareness-and-education') }}" id="editform">
            @csrf
