                        ...
                        <form class="forms-sample" action="{{ route('update-early-warning-system') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">{{$warning_system->english_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">{{$warning_system->marathi_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_description"
                                            ...
                                            placeholder="Enter the Description">{{ $warning_system->english_description }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            ...
                                            placeholder="Enter the Description">{{ $warning_system->marathi_description }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('websitedocument/images/preparedness/early-warning/' . $warning_system->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('websitedocument/images/preparedness/early-warning/' . $warning_system->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
                                </div>
