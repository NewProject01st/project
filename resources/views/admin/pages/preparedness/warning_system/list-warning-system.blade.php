...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                Early Warning System <a href="{{ route('add-early-warning-system') }}"
                                    ...
                                    <table id="order-listing" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <img
                                                        src="{{ asset('websitedocument/images/preparedness/early-warning/' . $item->english_image) }}" />
                                                </td>
                                                <td> <img
                                                        src="{{ asset('websitedocument/images/preparedness/early-warning/' . $item->marathi_image) }}" />
                                                </td>
