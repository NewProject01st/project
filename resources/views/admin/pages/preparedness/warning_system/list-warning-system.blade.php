...
@section('content')
    ...
    <div class="main-panel">
                                                ...
                                                @foreach ($warning_system as $item)
                                                    <tr>
                                                        ...
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_VIEW') }}{{ $item->english_image }}" alt=" {{ strip_tags($item['english_title']) }} Image"/>
                                                        </td>
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_VIEW') }}{{ $item->marathi_image }}" alt=" {{ strip_tags($item['marathi_title']) }} प्रतिमा"/>
                                                        </td>
        ...
        <form method="GET" action="{{ url('/edit-early-warning-system') }}" id="editform">
            @csrf
