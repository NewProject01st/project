                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <img src="{{ Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_VIEW') }}{{ $warning_system->english_image }}"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 pt-2">
                                            <img src="{{ Config::get('DocumentConstant.EARLY_WARNING_SYSTEM_VIEW') }}{{ $warning_system->marathi_image }}"
                                                style="width:300px; height:150px;" alt=" {{ strip_tags($warning_system['marathi_title']) }} छायाचित्र"/>
                                        </div>
                                    </div>
