                        ...
                        <form class="forms-sample" action="{{ route('update-capacity-building-and-training') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">{{$capacity_training->english_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">{{$capacity_training->marathi_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_description"
                                            ...
                                            placeholder="Enter the Description">{{ $capacity_training->english_description }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            ...
                                            placeholder="Enter the Description">{{ $capacity_training->marathi_description }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('websitedocument/images/preparedness/capacity-training/' . $capacity_training->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('websitedocument/images/preparedness/capacity-training/' . $capacity_training->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
                                </div>
