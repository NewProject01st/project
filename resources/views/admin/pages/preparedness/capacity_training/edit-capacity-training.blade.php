                        ...
                        <form class="forms-sample" action="{{ route('update-capacity-building-and-training') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">@if (old('english_title')){{ old('english_title') }}@else{{ $capacity_training->english_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">@if (old('marathi_title')){{ old('marathi_title') }}@else{{ $capacity_training->marathi_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('english_description')){{ old('english_description') }}@else{{ $capacity_training->english_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('marathi_description')){{ old('marathi_description') }}@else{{ $capacity_training->marathi_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="english"
                                        src="{{ asset('storage/images/preparedness/capacity-training/' . $capacity_training->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="marathi"
                                        src="{{ asset('storage/images/preparedness/capacity-training/' . $capacity_training->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
                            ...
                            <input type="hidden" name="id" id="id" class="form-control"
                                value="{{ $capacity_training->id }}" placeholder="">
                        </form>
                    </div>
                </div>
            </div>
