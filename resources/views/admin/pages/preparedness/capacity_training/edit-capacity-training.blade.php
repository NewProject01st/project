...
{{ old('english_title') }}@else{{ strip_tags($capacity_training->english_title) }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ strip_tags($capacity_training->marathi_title) }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $capacity_training->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $capacity_training->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.CAPACITY_TRAINING_VIEW') }}{{ $capacity_training->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.CAPACITY_TRAINING_VIEW') }}{{ $capacity_training->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
