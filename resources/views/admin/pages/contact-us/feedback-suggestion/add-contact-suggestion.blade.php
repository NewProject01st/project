                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control full_name" name="full_name"
                                            placeholder="Enter the Full Name" id="full_name"><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control email" name="email"
                                            placeholder="Enter the email" id="email"><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="subject"
                                            placeholder="Enter the subject" id="subject"><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="suggestion" id="suggestion"
                                            placeholder="Enter the suggestion"></textarea>
