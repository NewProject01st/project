                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="english_pdf" id="english_pdf" accept=".pdf" value="{{ old('english_pdf') }}"><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="marathi_pdf" id="marathi_pdf" accept=".pdf" value="{{ old('marathi_pdf') }}"><br>
