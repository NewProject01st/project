...
@section('content')
    <?php $data_permission = getPermissionForCRUDPresentOrNot('list-disaster-management-guidelines', session('permissions'));
    ?>
    <div class="main-panel">
            ...
            <div class="page-header">
                <h3 class="page-title">
                    ...
                    @if (in_array('per_add', $data_permission))
                        <a href="{{ route('add-disaster-management-guidelines') }}" class="btn btn-sm btn-primary ml-3">+
                            Add</a>
                    @endif
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('list-disaster-management-guidelines') }}"> Policies & Guidelines</a></li>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                @if (in_array('per_update', $data_permission))
                                                                    <a href="{{ route('edit-disaster-management-guidelines', base64_encode($item->id)) }}"
        ...
        <form method="POST" action="{{ url('/delete-disaster-management-guidelines') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-disaster-management-guidelines') }}" id="showform">
            @csrf
