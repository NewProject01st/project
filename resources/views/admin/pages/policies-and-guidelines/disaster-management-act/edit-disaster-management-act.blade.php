        ...
        <div class="content-wrapper mt-6">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('list-disaster-management-act') }}">Policies and
                                Legislation</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Update Disaster Management Act
                        </li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('update-disaster-management-act') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 text-center">
                                        ...
                                        <span><a href="{{ route('list-disaster-management-act') }}"
