        ...
        <div class="content-wrapper mt-7">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('list-district-disaster-management-plan') }}"> Policies & Guidelines</a></li>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                @if (in_array('per_update', $data_permission))
                                                                    <a href="{{ route('edit-district-disaster-management-plan', base64_encode($item->id)) }}"
