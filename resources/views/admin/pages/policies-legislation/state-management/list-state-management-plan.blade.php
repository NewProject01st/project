                                                ...
                                                @foreach ($state_management as $item)
                                                    <tr>
                                                        ...
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.STATE_DISASTER_PLAN_VIEW') }}{{ $item->english_image }}" />
                                                        </td>
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.STATE_DISASTER_PLAN_VIEW') }}{{ $item->marathi_image }}" />
                                                        </td>
