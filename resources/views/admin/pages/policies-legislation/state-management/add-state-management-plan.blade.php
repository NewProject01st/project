                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="english_image" id="english_image" accept="image/*" {{ old('english_image') }}><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="marathi_image">Image Marathi</label>&nbsp<span
                                            class="red-text">*</span><br>
                                        <input type="file" name="marathi_image" id="marathi_image" accept="image/*" {{ old('marathi_image') }}><br>
