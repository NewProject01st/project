...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                State Disaster Management policy <a href="{{ route('add-state-disaster-management-policy') }}"
                    class="btn btn-sm btn-primary ml-3">+
                    Add</a>
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#"> State Disaster Management policy</a></li>
                                    ...
                                    <table id="order-listing" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <img
                                                        src="{{ asset('storage/images/policies-legislation/state-policy/' . $item->english_image) }}" />
                                                </td>
                                                <td> <img
                                                        src="{{ asset('storage/images/policies-legislation/state-policy/' . $item->marathi_image) }}" />
                                                </td>
    ...
    <form method="POST" action="{{ url('/edit-state-disaster-management-policy') }}" id="editform">
        @csrf
