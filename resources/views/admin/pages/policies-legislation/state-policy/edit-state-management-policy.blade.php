                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="english_title">Title English</label>&nbsp<span
                                                class="red-text">*</span>
                                            <textarea class="form-control english_title" name="english_title" id="english_title" placeholder="Enter the Title">{{ $state_policy->english_title }}</textarea>
...
{{ old('english_description') }}@else{{ $state_policy->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $state_policy->marathi_description }}
@endif
</textarea>
