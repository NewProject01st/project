                        ...
                        <form class="forms-sample" action="{{ route('update-district-disaster-management-plan') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">@if (old('english_title')){{ old('english_title') }}@else{{ $district_management->english_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">@if (old('marathi_title')){{ old('marathi_title') }}@else{{ $district_management->marathi_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('english_description')){{ old('english_description') }}@else{{ $district_management->english_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('marathi_description')){{ old('marathi_description') }}@else{{ $district_management->marathi_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="english"
                                        src="{{ asset('storage/images/policies-legislation/district-plan/' . $district_management->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="marathi"
                                        src="{{ asset('storage/images/policies-legislation/district-plan/' . $district_management->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
