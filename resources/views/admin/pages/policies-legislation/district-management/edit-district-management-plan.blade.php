                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="english_title"
                                                ...
                                                value="@if (old('english_title')) {{ old('english_title') }}@else{{ $district_management->english_title }} @endif">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="marathi_title"
                                                ...
                                                value="@if (old('marathi_title')) {{ old('marathi_title') }}@else{{ $district_management->marathi_title }} @endif">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="policies_year" name="policies_year">
                                                ...
                                                @for ($year = date('Y'); $year >= 1950; $year--)
                                                    <option value="{{ $year }}"
                                                        @if (old('policies_year', $district_management->policies_year) == $year) selected @endif>
                                                        {{ $year }}</option>
                                                @endfor
                                            </select>
