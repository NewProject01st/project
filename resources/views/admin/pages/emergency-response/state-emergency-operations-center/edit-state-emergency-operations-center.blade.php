                        ...
                        <form class="forms-sample" action='{{ route('update-state-emergency-operations-center') }}'
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">{{ $stateemergencyoperationscenter->english_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">{{ $stateemergencyoperationscenter->marathi_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="english"
                                        src="{{ asset('storage/images/emergency-response/state-emergency-operations-center/' . $stateemergencyoperationscenter->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="marathi"
                                        src="{{ asset('storage/images/emergency-response/state-emergency-operations-center/' . $stateemergencyoperationscenter->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
