        ...
        <div class="content-wrapper mt-6">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('list-state-emergency-operations-center') }}">Emergency Response</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Update State Emergency Operations Center
                        </li>
                    </ol>
                </nav>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control english_title" name="english_title" id="english_title" placeholder="Enter the Title">{{ strip_tags($stateemergencyoperationscenter->english_title) }}</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control marathi_title" name="marathi_title" id="marathi_title" placeholder="Enter the Title">{{strip_tags($stateemergencyoperationscenter->marathi_title) }}</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.STATE_OPERATION_CENTER_VIEW') }}{{ $stateemergencyoperationscenter->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.STATE_OPERATION_CENTER_VIEW') }}{{ $stateemergencyoperationscenter->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
