                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ old('english_title') }}@else{{ strip_tags($stateemergencyoperationscenter->english_title) }}
                                            @endif">
                                                {{-- {{ strip_tags($stateemergencyoperationscenter->english_title) }}</input> --}}
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ old('marathi_title') }}@else{{ strip_tags($stateemergencyoperationscenter->marathi_title) }}
                                            @endif">
