                                             ...
                                             <tbody>
                                                 @foreach ($stateemergencyoperationscenter as $item)
                                                     <tr>
                                                         ...
                                                         <td> <img
                                                                 src="{{ asset('storage/images/state-emergency-operations-center/' . $item->english_image) }}" />
                                                         </td>
                                                         <td> <img
                                                                 src="{{ asset('storage/images/state-emergency-operations-center/' . $item->marathi_image) }}" />
                                                         </td>
                                                         <!-- <td>
