                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <img src="{{ asset('storage/images/state-emergency-operations-center/' . $stateemergencyoperationscenter->english_image) }}"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 pt-2">
                                            <img src="{{ asset('storage/images/state-emergency-operations-center/' . $stateemergencyoperationscenter->marathi_image) }}"
                                                style="width:70px; height:70px;" />
                                        </div>
                                    </div>
                                </div>
