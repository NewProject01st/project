        ...
        <div class="content-wrapper mt-6">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('list-district-emergency-operations-center') }}">Dashboard</a></li>
...
{{ old('marathi_title') }}@else{{ $districtemergencyoperationscenter->marathi_title }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $districtemergencyoperationscenter->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $districtemergencyoperationscenter->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_VIEW') }}{{ $districtemergencyoperationscenter->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_VIEW') }}{{ $districtemergencyoperationscenter->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
