 ...
 @section('content')
     <?php $data_permission = getPermissionForCRUDPresentOrNot('list-district-emergency-operations-center', session('permissions'));
     ?>
     <div class="main-panel">
             ...
             <div class="page-header">
                 <h3 class="page-title">
                     ...
                     {{-- @if (in_array('per_add', $data_permission))
                         <a href="{{ route('add-district-emergency-operations-center') }}"
                 ...
                 <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                         <li class="breadcrumb-item"><a href="{{ route('list-district-emergency-operations-center') }}">Emergency Response</a></li>
                                                 ...
                                                 @foreach ($districtemergencyoperationscenter as $item)
                                                     <tr>
                                                         ...
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_VIEW') }}{{ $item->english_image }}"
                                                                 alt=" {{ strip_tags($item['english_title']) }} Image" />
                                                         </td>
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.DISTRICT_OPERATION_CENTER_VIEW') }}{{ $item->marathi_image }}"
         ...
         <form method="GET" action="{{ url('/edit-district-emergency-operations-center') }}" id="editform">
             @csrf
