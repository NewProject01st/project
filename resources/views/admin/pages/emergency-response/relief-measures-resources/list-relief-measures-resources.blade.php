                                                 ...
                                                 @foreach ($reliefmeasuresresources as $item)
                                                     <tr>
                                                         ...
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.RELIEF_MEASURES_RESOURCES_VIEW') }}{{ $item->english_image }}" alt=" {{ strip_tags($item['english_title']) }} Image"/>
                                                         </td>
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.RELIEF_MEASURES_RESOURCES_VIEW') }}{{ $item->marathi_image }}" alt=" {{ strip_tags($item['marathi_title']) }} प्रतिमा"/>
                                                         </td>
                                                         <!-- <td>
