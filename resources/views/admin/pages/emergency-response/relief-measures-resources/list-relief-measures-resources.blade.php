 ...
 <div class="main-panel">
     <div class="content-wrapper">
         <div class="page-header">
             <h3 class="page-title">
                 Relief Measures Resources List <a href="{{ route('add-relief-measures-resources') }}"
                                     ...
                                     <table id="order-listing" class="table table-bordered">
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/emergency-response/relief-measures-resources/' . $item->english_image) }}" />
                                                 </td>
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/emergency-response/relief-measures-resources/' . $item->marathi_image) }}" />
                                                 </td>
                                                 <!-- <td>
                                                 ...
                                                 <td class="d-flex">
                                                     ...
                                                     <a data-id="{{ $item->id }}"
                                                         ...
                                                         title="Delete Relief Measures Resources"><i
     ...
     <form method="POST" action="{{ url('/edit-relief-measures-resources') }}" id="editform">
         @csrf
