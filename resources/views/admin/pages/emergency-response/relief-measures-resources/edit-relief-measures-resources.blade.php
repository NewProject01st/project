        ...
        <div class="content-wrapper mt-6">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('list-relief-measures-resources') }}">Emergency Response</a></li>
...
{{ old('english_description') }}@else{{ $reliefmeasuresresources->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $reliefmeasuresresources->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.RELIEF_MEASURES_RESOURCES_VIEW') }}{{ $reliefmeasuresresources->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.RELIEF_MEASURES_RESOURCES_VIEW') }}{{ $reliefmeasuresresources->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
