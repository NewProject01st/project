...
{{ old('english_title') }}@else{{ strip_tags($evacuationplans->english_title) }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ strip_tags($evacuationplans->marathi_title) }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $evacuationplans->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $evacuationplans->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.EVACUATION_PLAN_VIEW') }}{{ $evacuationplans->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.EVACUATION_PLAN_VIEW') }}{{ $evacuationplans->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
                                    ...
                                    <div class="col-md-12 col-sm-12 text-center mt-3">
                                        ...
                                        <span><a href="{{ route('list-evacuation-plans') }}"
                                                class="btn btn-sm btn-sm btn-primary ">Back</a></span>
                                    </div>
                                </div>
