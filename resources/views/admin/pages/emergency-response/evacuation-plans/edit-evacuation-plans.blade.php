        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action='{{ route('update-evacuation-plans') }}'
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control english_title" name="english_title" id="english_title" placeholder="Enter the Title">{{ $evacuationplans->english_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control marathi_title" name="marathi_title" id="marathi_title" placeholder="Enter the Title">{{ $evacuationplans->marathi_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('websitedocument/images/emergency-response/evacuation-plans/' . $evacuationplans->english_image) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('websitedocument/images/emergency-response/evacuation-plans/' . $evacuationplans->marathi_image) }}"
                                            class="img-fluid img-thumbnail" width="150">
                                    </div>
