 ...
 @section('content')
     ...
     <div class="main-panel">
                                                 ...
                                                 @foreach ($evacuationplans as $item)
                                                     <tr>
                                                         ...
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.EVACUATION_PLAN_VIEW') }}{{ $item->english_image }}" alt=" {{ strip_tags($item['english_title']) }} Image"/>
                                                         </td>
                                                         <td> <img class="img-size"
                                                                 src="{{ Config::get('DocumentConstant.EVACUATION_PLAN_VIEW') }}{{ $item->marathi_image }}" alt=" {{ strip_tags($item['marathi_title']) }} प्रतिमा"/>
                                                         </td>
                                                         <!-- <td>
         ...
         <form method="GET" action="{{ url('/edit-evacuation-plans') }}" id="editform">
             @csrf
