                                     ...
                                     <table id="order-listing" class="table table-bordered">
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td> <img
                                                         src="{{ asset('storage/images/emergency-response/evacuation-plans/' . $item->english_image) }}" />
                                                 </td>
                                                 <td> <img
                                                         src="{{ asset('storage/images/emergency-response/evacuation-plans/' . $item->marathi_image) }}" />
                                                 </td>
                                                 <!-- <td>
