                        ...
                        <form class="forms-sample" action='{{ route('update-search-rescue-teams') }}' method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="english"
                                        src="{{ asset('storage/images/emergency-response/search-rescue-teams/' . $searchrescueteams->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="marathi"
                                        src="{{ asset('storage/images/emergency-response/search-rescue-teams/' . $searchrescueteams->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
