     ...
     <div class="main-panel">
         <div class="content-wrapper">
             <div class="page-header">
                 <h3 class="page-title">
                    Search Rescue Team List <a href="{{ route('add-search-rescue-teams') }}"
                                             ...
                                             <tbody>
                                                 @foreach ($searchrescueteams as $item)
                                                     <tr>
                                                         ...
                                                         <td> <img
                                                                 src="{{ asset('websitedocument/images/emergency-response/search-rescue-teams/' . $item->english_image) }}" />
                                                         </td>
                                                         <td> <img
                                                                 src="{{ asset('websitedocument/images/emergency-response/search-rescue-teams/' . $item->marathi_image) }}" />
                                                         </td>
                                                         <!-- <td>
