                                ...
                                <div class="col-12">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($searchrescueteams->english_title) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($searchrescueteams->marathi_title) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($searchrescueteams->english_description) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($searchrescueteams->marathi_description) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 pt-2">
                                            <img src="{{ Config::get('DocumentConstant.SEARCH_RESCUE_TEAM_VIEW') }}{{ $searchrescueteams->marathi_image }}"
                                                style="width:300px; height:150px;" alt=" {{ strip_tags($searchrescueteams['marathi_title']) }} छायाचित्र"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
