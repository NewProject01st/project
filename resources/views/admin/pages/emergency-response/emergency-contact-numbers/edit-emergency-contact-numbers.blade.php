                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control english_title" name="english_title" id="english_title" placeholder="Enter the Title">{{ $emergencycontactnumbers->english_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control marathi_title" name="marathi_title" id="marathi_title" placeholder="Enter the Title">{{ $emergencycontactnumbers->marathi_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control english_description" name="english_description" id="english_description"
                                                placeholder="Enter the Description">{{ $emergencycontactnumbers->english_description }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('websitedocument/images/emergency-response/emergency-contact-numbers/' . $emergencycontactnumbers->english_image) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('websitedocument/images/emergency-response/emergency-contact-numbers/' . $emergencycontactnumbers->marathi_image) }}"
                                            class="img-fluid img-thumbnail" width="150">
                                    </div>
