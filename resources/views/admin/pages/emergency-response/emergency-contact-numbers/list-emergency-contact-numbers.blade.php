 ...
 <div class="main-panel">
     <div class="content-wrapper">
         <div class="page-header">
             <h3 class="page-title">
                 Emergency Contact Numbers List <a href="{{ route('add-emergency-contact-numbers') }}"
                                     ...
                                     <table id="order-listing" class="table table-bordered">
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/emergency-response/emergency-contact-numbers/' . $item->english_image) }}" />
                                                 </td>
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/emergency-response/emergency-contact-numbers/' . $item->marathi_image) }}" />
                                                 </td>
                                                 <!-- <td>
     ...
     <form method="POST" action="{{ url('/edit-emergency-contact-numbers') }}" id="editform">
         @csrf
