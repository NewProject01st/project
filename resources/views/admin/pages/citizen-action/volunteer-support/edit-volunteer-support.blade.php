...
{{ old('english_title') }}@else{{ $volunteer_support->english_title }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ $volunteer_support->marathi_title }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $volunteer_support->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $volunteer_support->marathi_description }}
@endif
</textarea>
