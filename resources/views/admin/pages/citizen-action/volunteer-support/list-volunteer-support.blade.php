...
@section('content')
    <?php $data_permission = getPermissionForCRUDPresentOrNot('list-volunteer-citizen-support', session('permissions'));
    ?>
    <div class="main-panel">
            ...
            <div class="page-header">
                <h3 class="page-title">
                    ...
                    {{-- @if (in_array('per_add', $data_permission))
                        <a href="{{ route('add-volunteer-citizen-support') }}" class="btn btn-sm btn-primary ml-3">+
                            Add</a>
                    @endif --}}
        ...
        <form method="GET" action="{{ url('/edit-volunteer-citizen-support') }}" id="editform">
            @csrf
