...
{{ old('english_title') }}@else{{ $feedback_data->english_title }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ $feedback_data->marathi_title }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $feedback_data->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $feedback_data->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.CITIZEN_FEEDBACK_SUGGESTION_VIEW') }}{{ $feedback_data->english_image }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.CITIZEN_FEEDBACK_SUGGESTION_VIEW') }}{{ $feedback_data->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
                                ...
                                <input type="hidden" name="id" id="id" class="form-control"
                                    value="{{ $feedback_data->id }}" placeholder="">
                            </form>
                        </div>
                    </div>
                </div>
