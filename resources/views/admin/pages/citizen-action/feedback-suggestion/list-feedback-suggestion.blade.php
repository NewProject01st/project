...
@section('content')
    <?php $data_permission = getPermissionForCRUDPresentOrNot('list-citizen-feedback-and-suggestion', session('permissions'));
    ?>
    <div class="main-panel">
            ...
            <div class="page-header">
                <h3 class="page-title">
                    ...
                    @if (in_array('per_add', $data_permission))
                        <a href="{{ route('add-citizen-feedback-and-suggestion') }}" class="btn btn-sm btn-primary ml-3">+
                            Add</a>
                    @endif
                                                ...
                                                @foreach ($feedback_data as $item)
                                                    <tr>
                                                        ...
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.CITIZEN_FEEDBACK_SUGGESTION_VIEW') }}{{ $item->english_image }}" />
                                                        </td>
                                                        <td> <img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.CITIZEN_FEEDBACK_SUGGESTION_VIEW') }}{{ $item->marathi_image }}" />
                                                        </td>
        ...
        <form method="GET" action="{{ url('/edit-citizen-feedback-and-suggestion') }}" id="editform">
            @csrf
