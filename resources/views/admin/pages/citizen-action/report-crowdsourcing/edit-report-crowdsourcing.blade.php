...
{{ old('marathi_title') }}@else{{ $crowdsourcing->marathi_title }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $crowdsourcing->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.REPORT_INCIDENT_CROWDSOURCING_VIEW') }}{{ $crowdsourcing->english_image }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="marathi"
                                            src="{{ Config::get('DocumentConstant.REPORT_INCIDENT_CROWDSOURCING_VIEW') }}{{ $crowdsourcing->marathi_image }}"
                                            class="img-fluid img-thumbnail" width="150">
                                ...
                                <input type="hidden" name="id" id="id" class="form-control"
                                    value="{{ $crowdsourcing->id }}" placeholder="">
                            </form>
                        </div>
                    </div>
                </div>
