...
{{ old('english_title') }}@else{{ $objectivegoals->english_title }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ $objectivegoals->marathi_title }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $objectivegoals->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $objectivegoals->marathi_description }}
@endif
</textarea>
        ...
        <script>
            $(document).ready(function() {
                ...
                function checkFormValidity() {
                    ...
                    // if (english_title && marathi_title && english_description && marathi_description && english_image &&
                    //     marathi_image) {
                ...
                $("#regForm").validate({
                    rules: {
                        ...
                        english_image: {
                            ...
                            filesize: {
                                min: {{ config('AllFileValidation.OBJECTIVE_GOALS_IMAGE_MIN_SIZE') }},
                                max: {{ config('AllFileValidation.OBJECTIVE_GOALS_IMAGE_MAX_SIZE') }},
                            },
                        },
                        marathi_image: {
                            required: true,
