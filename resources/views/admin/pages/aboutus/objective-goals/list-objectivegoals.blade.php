                                                ...
                                                @foreach ($objectivegoals as $item)
                                                    <tr>
                                                        ...
                                                        <td><img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.OBJECTIVE_GOALS_VIEW') }}{{ $item->english_image }}" alt=" {{ strip_tags($item['english_title']) }} Image"/>
                                                        </td>
                                                        <td><img class="img-size"
                                                                src="{{ Config::get('DocumentConstant.OBJECTIVE_GOALS_VIEW') }}{{ $item->marathi_image }}" alt=" {{ strip_tags($item['marathi_title']) }} प्रतिमा"/>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
