    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" action='{{ route('update-disastermanagementportal') }}' method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">@if (old('english_title')){{ old('english_title') }}@else{{ $disastermanagementportal->english_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">@if (old('marathi_title')){{ old('marathi_title') }}@else{{ $disastermanagementportal->marathi_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('english_description')){{ old('english_description') }}@else{{ $disastermanagementportal->english_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            ...
                                            placeholder="Enter the Description">@if (old('marathi_description')){{ old('marathi_description') }}@else{{ $disastermanagementportal->marathi_description }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="english"
                                        src="{{ asset('storage/images/aboutus/disaster-management-portal/' . $disastermanagementportal->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="marathi"
                                        src="{{ asset('storage/images/aboutus/disaster-management-portal/' . $disastermanagementportal->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
