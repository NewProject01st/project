 ...
 <div class="main-panel">
     <div class="content-wrapper">
         <div class="page-header">
             <h3 class="page-title">
                 State Disaster Management Authority List <a href="{{ route('add-statedisastermanagementauthority') }}"
                             ...
                             <div class="col-12">
                                 <div class="table-responsive">
                                     <table id="order-listing" class="table table-bordered">
                                         ...
                                         <tbody>
                                             @foreach ($statedisastermanagementauthority as $item)
                                             <tr>
                                                 ...
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/aboutus/state-disaster-management-authority/' . $item->english_image) }}" />
                                                 </td>
                                                 <td> <img
                                                         src="{{ asset('websitedocument/images/aboutus/state-disaster-management-authority/' . $item->marathi_image) }}" />
                                                 </td>
                                                 <!-- <td>
                                                 ...
                                                 <td class="d-flex">
                                                     ...
                                                     <a data-id="{{ $item->id }}"
                                                         ...
                                                         title="Delete State Disaster Management"><i
     ...
     <form method="POST" action="{{ url('/delete-statedisastermanagementauthority') }}" id="deleteform">
         @csrf
         <input type="hidden" name="delete_id" id="delete_id" value="">
     </form>
     <form method="POST" action="{{ url('/show-statedisastermanagementauthority') }}" id="showform">
         @csrf
