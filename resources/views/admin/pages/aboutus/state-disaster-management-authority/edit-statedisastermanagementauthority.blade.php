                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ old('english_title') }}@else{{ strip_tags($statedisastermanagementauthority->english_title) }}
                                            @endif">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ old('marathi_title') }}@else{{ strip_tags($statedisastermanagementauthority->marathi_title) }}
                                            @endif">
