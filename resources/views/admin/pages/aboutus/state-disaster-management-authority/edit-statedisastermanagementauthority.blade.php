...
{{ old('english_title') }}@else{{ $statedisastermanagementauthority->english_title }}
@endif
</textarea>
...
{{ old('marathi_title') }}@else{{ $statedisastermanagementauthority->marathi_title }}
@endif
</textarea>
...
{{ old('english_description') }}@else{{ $statedisastermanagementauthority->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $statedisastermanagementauthority->marathi_description }}
@endif
</textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="english_image">English </label>
                ...
                $("#regForm").validate({
                    rules: {
                        ...
                        english_image: {
                            ...
                            filesize: {
                                min: {{ config('AllFileValidation.DISASTER_MANAGEMENT_AUTHORITY_IMAGE_MIN_SIZE') }},
                                max: {{ config('AllFileValidation.DISASTER_MANAGEMENT_AUTHORITY_IMAGE_MAX_SIZE') }},
                            },
                        },
                        marathi_image: {
                            required: true,
