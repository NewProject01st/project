                ...
                <div class="col-7 grid-margin ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 d-flex justify-content-end align-items-center">
                            <div>
                                <a href="{{ route('list-statedisastermanagementauthority') }}"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 pt-2">
                                            <img src="{{ Config::get('DocumentConstant.ABOUT_US_STATE_DISASTER_MGTAUTHORITY_VIEW') }}{{ $statedisastermanagementauthority->marathi_image }}"
                                                style="width:300px; height:150px;" alt=" {{ strip_tags($statedisastermanagementauthority['marathi_title']) }} छायाचित्र"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
