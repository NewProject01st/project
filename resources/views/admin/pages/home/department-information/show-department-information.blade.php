                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->english_title ?></label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->marathi_title ?></label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->english_description ?></label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->marathi_description ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->english_url ?></label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <label><?php echo $department_info->disaster_date ?></label>
                                    </div>
                                </div>
                                <div class="row ">
