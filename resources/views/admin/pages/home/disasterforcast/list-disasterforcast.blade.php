...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                Disaster Forcast List <a href="{{ route('add-disasterforcast') }}" class="btn btn-sm btn-primary ml-3">+
                    Add</a>
            </h3>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a data-id="{{ $item->id }}"
                                                        ...
                                                        title="Delete Forcast"><i class="fas fa-archive"></i></a>
    ...
    <form method="POST" action="{{ url('/edit-disasterforcast') }}" id="editform">
        @csrf
