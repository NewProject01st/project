                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <img src="{{ asset('websitedocument/images/disaster-forcast/' . $disasterforcast->english_image) }}"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 pt-2">
                                            <img src="{{ asset('websitedocument/images/disaster-forcast/' . $disasterforcast->marathi_image) }}"
                                                style="width:70px; height:70px;" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <a href="{{ asset('/websitedocument/pdf/disaster-forcast/' . $disasterforcast->english_pdf) }}"
                                    ...
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <a href="{{ asset('/websitedocument/pdf/disaster-forcast/' . $disasterforcast->marathi_pdf) }}"
                                                target="_blank"><img src="public/websitedocument/pdf/pdf.png" width="50px"
                                                    height="50px"></a>
                                        </div>
                                    </div>
