        ...
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Disaster Management News</a></li>
                                            ...
                                            <tbody>
                                                @foreach ($disaster_news as $item)
                                                    <tr>
                                                        ...
                                                        <td> <img
                                                                src="{{ asset('websitedocument/images/disaster-news/' . $item->english_image) }}" />
                                                        </td>
                                                        <td> <img
                                                                src="{{ asset('websitedocument/images/disaster-news/' . $item->marathi_image) }}" />
                                                        </td>
                                                        <td>
