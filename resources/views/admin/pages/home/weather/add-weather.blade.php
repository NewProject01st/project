                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_description"
                                            id="marathi_description" placeholder="Enter the Description">{{ old('english_description') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="english_pdf" id="english_pdf" accept=".pdf" value="{{ old('english_pdf') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="marathi_pdf" id="marathi_pdf" accept=".pdf" value="{{ old('marathi_pdf') }}">
