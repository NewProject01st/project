...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                Disaster Management Web Portal List <a href="{{ route('add-disaster-management-web-portal') }}"
                                    ...
                                    <table id="order-listing" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <img
                                                        src="{{ asset('storage/images/disaster_webportal/' . $item->english_image) }}" />
                                                </td>
                                                <td> <img
                                                        src="{{ asset('storage/images/disaster_webportal/' . $item->marathi_image) }}" />
                                                </td>
