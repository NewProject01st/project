                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control english_title" name="english_title" id="english_title" placeholder="Enter the Title">{{ $disaster_web_portal->english_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control marathi_title" name="marathi_title" id="marathi_title" placeholder="Enter the Title">{{ $disaster_web_portal->marathi_title }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="english_designation">Designation English</label><br>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="marathi_designation">Designation Marathi</label><br>
