                        ...
                        <form class="forms-sample" action="{{ route('update-disaster-management-web-portal') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="english_designation" id="english_designation"
                                            class="form-control" value="{{$disaster_web_portal->english_designation}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marathi_designation" id="marathi_designation"
                                            class="form-control" value="{{$disaster_web_portal->marathi_designation}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('storage/images/disaster_webportal/' . $disaster_web_portal->english_image) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('storage/images/disaster_webportal/' . $disaster_web_portal->marathi_image) }}"
                                        class="img-fluid img-thumbnail" width="150">
                                </div>
