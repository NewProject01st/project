                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">@if (old('english_title')){{ old('english_title') }}@else{{ $emergency_contact->english_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">@if (old('marathi_title')){{ old('marathi_title') }}@else{{ $emergency_contact->marathi_title }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_description" name="english_address"
                                            id="english_address"
                                            placeholder="Enter the Address">@if (old('english_address')){{ old('english_address') }}@else{{ $emergency_contact->english_address }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_description" name="marathi_address"
                                            id="marathi_address"
                                            placeholder="Enter the Address">@if (old('marathi_address')){{ old('marathi_address') }}@else{{ $emergency_contact->marathi_address }}@endif</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="english_number" id="english_number"
                                            class="form-control" value="@if (old('english_number')){{ old('english_number') }}@else{{ $emergency_contact->english_number }}@endif"
                                            placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marathi_number" id="marathi_number"
                                            class="form-control" value="@if (old('marathi_number')){{ old('marathi_number') }}@else{{ $emergency_contact->marathi_number }}@endif"
                                            placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="english_landline_no" id="english_landline_no"
                                            class="form-control" value="@if (old('english_landline_no')){{ old('english_landline_no') }}@else{{ $emergency_contact->english_landline_no }}@endif"
                                            placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marathi_landline_no" id="marathi_landline_no"
                                            class="form-control" value="@if (old('marathi_landline_no')){{ old('marathi_landline_no') }}@else{{ $emergency_contact->marathi_landline_no }}@endif"
                                            placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control"
                                            value="@if (old('email')){{ old('email') }}@else{{ $emergency_contact->email }}@endif" placeholder="">
                                        @if ($errors->has('email'))
