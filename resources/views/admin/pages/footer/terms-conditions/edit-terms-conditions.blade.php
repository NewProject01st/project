        ...
        <div class="content-wrapper mt-6">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('update-terms-conditions') }}" method="post"
...
{{ old('english_description') }}@else{{ $terms_conditions->english_description }}
@endif
</textarea>
...
{{ old('marathi_description') }}@else{{ $terms_conditions->marathi_description }}
@endif
</textarea>
                                ...
                                <input type="hidden" name="id" id="id" class="form-control"
                                    value="{{ $terms_conditions->id }}" placeholder="">
                            </form>
                        </div>
                    </div>
                </div>
