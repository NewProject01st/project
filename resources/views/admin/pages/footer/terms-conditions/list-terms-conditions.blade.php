...
@section('content')
    <?php $data_permission = getPermissionForCRUDPresentOrNot('list-terms-conditions', session('permissions'));
    ?>
    <div class="main-panel">
        <div class="content-wrapper mt-7">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('list-terms-conditions') }}">Footer</a></li>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="order-listing" class="table table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($terms_conditions as $item)
                                                    <tr>
        ...
        <form method="GET" action="{{ url('/edit-terms-conditions') }}" id="editform">
            @csrf
            <input type="hidden" name="edit_id" id="edit_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-one-terms-conditions') }}" id="activeform">
            @csrf
