        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Update Important Links</li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" action="{{ route('update-important-link') }}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control english_title" name="english_title"
                                            id="english_title"
                                            placeholder="Enter the Title">{{ $links->english_title }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control marathi_title" name="marathi_title"
                                            id="marathi_title"
                                            placeholder="Enter the Title">{{ $links->marathi_title }}</textarea>
                            ...
                            <input type="hidden" name="id" id="id" class="form-control" value="{{ $links->id }}"
                                placeholder="">
                        </form>
                    </div>
                </div>
