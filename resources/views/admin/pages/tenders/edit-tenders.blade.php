                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="english_title" id="english_title" class="form-control"
                                            value="{{ $tenders->english_title }}" placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marathi_title" id="marathi_title" class="form-control"
                                            value="{{ $tenders->marathi_title }}" placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="YYYY-MM-DD" name="end_date"
                                            id="end_date" value="{{ $tenders->end_date }}" required="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 text-center">
                                    ...
                                    <button type="submit" class="btn btn-danger"><a href="{{ route('list-tenders') }}"
                                            class="text-light">Cancel</a></button>
                                </div>
                            </div>
                            <input type="hidden" name="id" id="id" class="form-control" value="{{ $tenders->id }}"
                                placeholder="">
                        </form>
                    </div>
                </div>
