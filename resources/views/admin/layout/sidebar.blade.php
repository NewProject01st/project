      ...
      <nav class="sidebar sidebar-offcanvas fixed-nav" id="sidebar">
          <ul class="nav">
              ...
              @if (in_array('list-social-icon', $data_for_url) || in_array('list-sub-header-info', $data_for_url))
                  <li class="nav-item">
              ...
              @if (in_array('list-state-emergency-operations-center', $data_for_url) ||
                      ...
                      in_array('list-relief-measures-resources', $data_for_url) | in_array('list-search-rescue-teams', $data_for_url))
                  <li class="nav-item">
