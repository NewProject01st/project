                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Report an Incident : Crowdsorcing
                                    </h1>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="input" class="form-control" name="location"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="input" class="form-control" name="mobile_number"
