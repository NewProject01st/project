                            ...
                            @foreach ($data_output as $item)
                                <div class="deprt-txt">
                                    @if (session('language') == 'mar')
                                        ...
                                        <img src="{{ asset('websitedocument/images/emergency-response/evacuation-plans/' . $item['marathi_image']) }}"
                                    class="d-block w-100" alt="...">
                                        <p style="text-align: justify;"> <?php echo $item['marathi_description']; ?></p>
                                    @else
                                        <h3><?php echo $item['english_title']; ?> : </h3>
                                        <img src="{{ asset('websitedocument/images/emergency-response/evacuation-plans/' . $item['english_image']) }}"
                                    class="d-block w-100" alt="...">
