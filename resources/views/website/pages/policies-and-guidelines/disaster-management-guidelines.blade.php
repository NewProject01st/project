...
@section('content')
    ...
    <section class="wf100 subheader">
        <div class="container">
            ...
            <ul>
                <li> <a href="{{ route('disaster-management-guidelines') }}">
                        @if (session('language') == 'mar')
                ...
                <li>
                    @if (session('language') == 'mar')
                        {{ Config::get('marathi.POLICIES_LEGISLATION.POLICIES_LEGISLATION_SUB_LINK6') }}
                    @else
                        {{ Config::get('english.POLICIES_LEGISLATION.POLICIES_LEGISLATION_SUB_LINK6') }}
                    @endif
                </li>
            </ul>
        </div>
