...
@section('content')
    ...
    <section class="wf100 subheader">
        <div class="container">
            ...
            <ul>
                <li> <a href="{{ route('list-objectivegoals-web') }}">
                        @if (session('language') == 'mar')
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true">
                                    @if (session('language') == 'mar')
                                        {{ Config::get('marathi.ABOUT_US.OBJECTIVE') }}
                                    @else
                                        {{ Config::get('english.ABOUT_US.OBJECTIVE') }}
                                    @endif
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    @if (session('language') == 'mar')
                                        {{ Config::get('marathi.ABOUT_US.GOALS') }}
                                    @else
                                        {{ Config::get('english.ABOUT_US.GOALS') }}
                                    @endif
                                </button>
                            </li>
                                        ...
                                        @if (session('language') == 'mar')
                                            ...
                                            <p style="text-align: justify;">
                                                <img src="{{ Config::get('DocumentConstant.OBJECTIVE_GOALS_VIEW') }}{{ $data_output[0]['marathi_image'] }}"
                                                    ...
                                                    alt="{{ strip_tags($data_output[0]['marathi_title']) }} Image">
                                        ...
                                        @if (session('language') == 'mar')
                                            ...
                                            <p style="text-align: justify;">
                                                <img src="{{ Config::get('DocumentConstant.OBJECTIVE_GOALS_VIEW') }}{{ $data_output[1]['marathi_image'] }}"
                                                    class="d-block w-100 to_set_img"
                                                    alt="{{ strip_tags($data_output[1]['marathi_title']) }}">
