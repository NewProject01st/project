    ...
    @section('content')
        ...
        <section class="wf100 subheader">
            <div class="container">
                ...
                <ul>
                    <li> <a href="{{ route('list-state-management-policy-web') }}">
                            @if (session('language') == 'mar')
                                ...
                                @forelse ($data_output as $item)
                                    <tr class="">
                                        @if (session('language') == 'mar')
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center"> <a
                                                        href="{{ Config::get('DocumentConstant.STATE_DISASTER_POLICY_VIEW') }}{{ $item['marathi_pdf'] }}"
                                        ...
                                        @else
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center"> <a
                                                        href="{{ Config::get('DocumentConstant.STATE_DISASTER_POLICY_VIEW') }}{{ $item['english_pdf'] }}"
                                                        target="_blank"><img src="{{ asset('assets/images/pdf.png/') }}"
