                            ...
                            @forelse ($data_output as $item)
                                <div class="deprt-txt">
                                    @if (session('language') == 'mar')
                                        ...
                                        <img src="{{ Config::get('DocumentConstant.STATE_DISASTER_POLICY_VIEW') }}{{ $item['marathi_image'] }}"
                                            class="d-block w-100" alt="...">
                                        <p style="text-align: justify;"> <?php echo $item['marathi_description']; ?></p>
                                    @else
                                        <h3><?php echo $item['english_title']; ?> : </h3>
                                        <img src="{{ Config::get('DocumentConstant.STATE_DISASTER_POLICY_VIEW') }}{{ $item['english_image'] }}"
                                            class="d-block w-100" alt="...">
