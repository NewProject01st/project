    ...
    @section('content')
        ...
        <section class="wf100 subheader">
            <div class="container">
                ...
                <ul>
                    <li> <a href="{{ route('list-state-disaster-managementplan-web') }}">
                            @if (session('language') == 'mar')
                    ...
                    <li>
                        @if (session('language') == 'mar')
                            {{ Config::get('marathi.POLICIES_LEGISLATION.POLICIES_LEGISLATION_SUB_LINK1') }}
                        @else
                            {{ Config::get('english.POLICIES_LEGISLATION.POLICIES_LEGISLATION_SUB_LINK1') }}
                        @endif
                    </li>
                </ul>
            </div>
