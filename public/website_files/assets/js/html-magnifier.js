...
function HTMLMagnifier(options) {
  ...
  const magnifierTemplate = `<div class="magnifier" id="magnifier" style="display: none;position: fixed;overflow: hidden;background-color: white;border: 1px solid #555;border-radius: 4px;z-index:10000;">
